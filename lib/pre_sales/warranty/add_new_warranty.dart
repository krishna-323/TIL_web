...
class AddNewWarranty extends StatefulWidget {
  ...
  const AddNewWarranty({Key? key,  required this.selectedDestination, required this.drawerWidth }) : super(key: key);

  @override
  State<AddNewWarranty> createState() => _AddNewWarrantyState();
}

class _AddNewWarrantyState extends State<AddNewWarranty> {
