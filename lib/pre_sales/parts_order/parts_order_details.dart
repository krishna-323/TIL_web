...
class PartsOrderDetails extends StatefulWidget {
  final Map<dynamic, dynamic> invoiceData;
  final Map<dynamic, dynamic> docketDetails;
  const PartsOrderDetails(this.invoiceData,this.docketDetails, {Key? key}) : super(key: key);

  @override
  _PartsOrderDetailsState createState() => _PartsOrderDetailsState();
}

class _PartsOrderDetailsState extends State<PartsOrderDetails> {
  Map docketData ={};
  bool loading = false;
  double total = 0.0;
  String address = "";
