...
class PartOrderDetails extends StatefulWidget {
  ...
  const PartOrderDetails({Key? key, required this.drawerWidth, required this. selectedDestination, required Duration transitionDuration, required  Duration reverseTransitionDuration, required this.estimateItem}) : super(key: key);
