...
// import 'package:motows_web/utils/easy_side_menue/src/side_menu_toggle.dart';
...
//                     showToggle)
//                    Container(color:Color(0xff4e4f96),
//                    // height: 56,
//                   ),
//                  (widget.title != null && Global.style.displayMode == SideMenuDisplayMode.compact) ?
//                   Container(height: 56,color:Color(0xff4e4f96),    ):widget.title!,
//                 ...widget.items,
//               ],
//             ),
//           ),
...
//               child: Row(
//                 mainAxisAlignment: Global.displayModeState.value == SideMenuDisplayMode.open? MainAxisAlignment.end :MainAxisAlignment.center,crossAxisAlignment: CrossAxisAlignment.center,
//                 children: [
//                   Container(
//                     height: 56,
//
