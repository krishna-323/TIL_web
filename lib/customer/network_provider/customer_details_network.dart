...
class CustomerDetailsNetwork{
  Future<CustomerModel> fetchCustomerData(newcustomer_id) async{
    SharedPreferences prefs = await SharedPreferences.getInstance();

    String? authToken= prefs.getString("authToken");
    final response = await http.get(Uri.parse("https://msq5vv563d.execute-api.ap-south-1.amazonaws.com/stage1/api/newcustomer/get_newcustomer_by_id/$newcustomer_id"),
      headers: {
