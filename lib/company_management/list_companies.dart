...
class _CompanyManagementState extends State<CompanyManagement> {
  ...
  Future postCompanyDetails(companyList) async {
    String url =
        '${StaticData.url}company/add_company';
  ...
  //Edit api().
  Future editCompany(companyID,requestBody) async {
    String url ='${StaticData.url}company/patch/$companyID';
  ...
  Future deleteCompany(String companyId)async{
    ...
    String url= '${StaticData.url}company/delete_company/$companyId';
                                          ...
                                          onPressed: (){
                                            Navigator.of(context).push(PageRouteBuilder(
                                              pageBuilder: (context,animation1,animation2) => DealerList(
                                                companyName:listCompanies[i]['companyName'],
                                                        ...
                                                        children: [
                                                          Expanded(
                                                              child: Padding(
                                                                ...
                                                                child: SizedBox(height: 25,
                                                                    //   decoration: state.text.isNotEmpty ?BoxDecoration():BoxDecoration(boxShadow: [BoxShadow(color:Color(0xFFEEEEEE),blurRadius: 2)]),
                                                                    child: Text(displayListCompanies[i]['companyName']??"")
                                                                ),
                                                              )),
                                                          Expanded(
                                                              child: Padding(
                                                          ...
                                                          Expanded(
                                                              child: Padding(
                                                                ...
                                                                child: SizedBox(height: 25,
                                                                    //   decoration: state.text.isNotEmpty ?BoxDecoration():BoxDecoration(boxShadow: [BoxShadow(color:Color(0xFFEEEEEE),blurRadius: 2)]),
                                                                    child: Text(displayListCompanies[i]['zipCode'].toString())
                                                                ),
                                                              )),
                                                          // Padding(
                                                          ...
                                                          //                   editCompanyName.text=displayListCompanies[i]['companyName'];
                                                          ...
                                                          //                   editAddress1.text=displayListCompanies[i]['addressLine1'];
                                                          //                   final editAddress2 = TextEditingController();
                                                          //                   editAddress2.text=displayListCompanies[i]['addressLine2'];
                                                          //                   final editZipcode = TextEditingController();
                                                          //                   editZipcode.text=displayListCompanies[i]['zipCode'].toString();
                                                          //
                                                          ...
                                                          //                                                       'addressLine1':editAddress1.text,
                                                          //                                                       'addressLine2':editAddress2.text,
                                                                                                              ...
                                                                                                              onTap:(){
                                                                                                                if (editCompanyKey.currentState!.validate()) {
                                                                                                                  companyDetails = {
                                                                                                                    ...
                                                                                                                    'addressLine1':editAddress1.text,
                                                                                                                    'addressLine2':editAddress2.text,
                                                                                                                    'zipCode':int.parse(editZipcode.text)
                                                                                                                  };
                                                                                                                  editCompany(displayListCompanies[i]['companyId'],companyDetails);
                                                                                                                }
                                                                                                              },
                                                                                                            ),
                                                                                                          ),
